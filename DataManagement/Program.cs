    ...
    internal static class Program
    {
        ...
        private static void Main()
        {
            try
            {
                ...
                ServiceRuntime.RegisterServiceAsync("DataManagementType",
                    context => new DataManagement(context)).GetAwaiter().GetResult();

                ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(DataManagement).Name);
